...
<div class="section section-simTest">
	<div class="container mx-auto mb-4">
			<div class="img">
				<div class="content">
                    <div></div>
                    <form method="post" action="simTest2-4.php">
                        <input type="hidden" name="Q1" value="<?=$Q1?>">
                        <div class="form-control">
                            <input type="hidden" name="Q1" value="<?=$Q1?>">
                            
                            <label class="cursor-pointer label bordered">
                                <span class="label-text text-white text-3xl">운동이 좋다!</span> 
                                <div>
                                    <input type="radio" name="Q2" checked="checked" class="radio radio-primary" value="1"> 
                                    <span class="radio-mark"></span>
                                </div>
                            </label>
                            <label class="cursor-pointer label bordered">
                                <span class="label-text text-white text-3xl">사색이 좋다!</span> 
                                <div>
